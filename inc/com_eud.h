...
#define COM_ENDIANOPT_NOP           EUD_BIGENDIAN
#define COM_ENDIANOP_TX_TMOUT       EUD_BIGENDIAN
#define COM_ENDIANOP_RX_TMOUT       EUD_BIGENDIAN
#define COM_ENDIANOP_PORT_RST       EUD_BIGENDIAN
