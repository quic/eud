...
#define CTL_ENDIANOPT_NOP                   EUD_BIGENDIAN 
#define CTL_ENDIANOPT_EUD_VERSION_READ      EUD_BIGENDIAN 
#define CTL_ENDIANOPT_DEVICE_ID_READ        EUD_LITTLEENDIAN 
#define CTL_ENDIANOPT_EUD_STATUS_READ       EUD_BIGENDIAN 
#define CTL_ENDIANOPT_CTLIN_READ            EUD_BIGENDIAN 
#define CTL_ENDIANOPT_CTLOUT_READ           EUD_BIGENDIAN 
#define CTL_ENDIANOPT_CTLOUT_WRITE          EUD_BIGENDIAN 
#define CTL_ENDIANOPT_CTLOUT_SET            EUD_BIGENDIAN 
#define CTL_ENDIANOPT_CTLOUT_CLR            EUD_BIGENDIAN 
#define CTL_ENDIANOPT_PERIPH_RST            EUD_BIGENDIAN 
#define CTL_ENDIANOPT_FLAG_IN               EUD_BIGENDIAN 
#define CTL_ENDIANOPT_FLAG_OUT_WRITE        EUD_BIGENDIAN 
#define CTL_ENDIANOPT_FLAG_OUT_SET          EUD_BIGENDIAN 
#define CTL_ENDIANOPT_FLAG_OUT_CLR          EUD_BIGENDIAN 
